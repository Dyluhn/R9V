...
static void ggml_moe_q4_0_q8_1_cuda(
    ...
    const int tokens_post_padded, hipStream_t stream) {
  ...
  if (nrows_x % mmq_y == 0) {
   ...
   hipLaunchKernelGGL(( moe_q4_0<scalar_t, need_check>), dim3(block_nums), dim3(block_dims), 0, stream, 
...
static void ggml_moe_q4_1_q8_1_cuda(
  ...
  if (nrows_x % mmq_y == 0) {
    constexpr bool need_check = false;
   hipLaunchKernelGGL(( moe_q4_1<scalar_t, need_check>), dim3(block_nums), dim3(block_dims), 0, stream, 
        w, inp, dst, sorted_token_ids, expert_ids, num_tokens_post_padded,
        exp_stride, ncols_x, nrows_x, ncols_y, nrows_y, nrows_dst, top_k);
  } else {
    constexpr bool need_check = true;
...
static void ggml_moe_q5_0_q8_1_cuda(
  ...
  if (nrows_x % mmq_y == 0) {
    constexpr bool need_check = false;
   hipLaunchKernelGGL(( moe_q5_0<scalar_t, need_check>), dim3(block_nums), dim3(block_dims), 0, stream, 
        w, inp, dst, sorted_token_ids, expert_ids, num_tokens_post_padded,
        exp_stride, ncols_x, nrows_x, ncols_y, nrows_y, nrows_dst, top_k);
  } else {
    constexpr bool need_check = true;
...
static void ggml_moe_q5_1_q8_1_cuda(
  ...
  if (nrows_x % mmq_y == 0) {
    constexpr bool need_check = false;
   hipLaunchKernelGGL(( moe_q5_1<scalar_t, need_check>), dim3(block_nums), dim3(block_dims), 0, stream, 
        w, inp, dst, sorted_token_ids, expert_ids, num_tokens_post_padded,
        exp_stride, ncols_x, nrows_x, ncols_y, nrows_y, nrows_dst, top_k);
  } else {
    constexpr bool need_check = true;
...
static void ggml_moe_q8_0_q8_1_cuda(
  ...
  if (nrows_x % mmq_y == 0) {
    constexpr bool need_check = false;
   hipLaunchKernelGGL(( moe_q8_0<scalar_t, need_check>), dim3(block_nums), dim3(block_dims), 0, stream, 
        w, inp, dst, sorted_token_ids, expert_ids, num_tokens_post_padded,
        exp_stride, ncols_x, nrows_x, ncols_y, nrows_y, nrows_dst, top_k);
  } else {
    constexpr bool need_check = true;
...
static void ggml_moe_q2_K_q8_1_cuda(
  ...
  if (nrows_x % mmq_y == 0) {
    constexpr bool need_check = false;
   hipLaunchKernelGGL(( moe_q2_K<scalar_t, need_check>), dim3(block_nums), dim3(block_dims), 0, stream, 
        w, inp, dst, sorted_token_ids, expert_ids, num_tokens_post_padded,
        exp_stride, ncols_x, nrows_x, ncols_y, nrows_y, nrows_dst, top_k);
  } else {
    constexpr bool need_check = true;
...
static void ggml_moe_q3_K_q8_1_cuda(
  ...
  if (nrows_x % mmq_y == 0) {
    constexpr bool need_check = false;
   hipLaunchKernelGGL(( moe_q3_K<scalar_t, need_check>), dim3(block_nums), dim3(block_dims), 0, stream, 
        w, inp, dst, sorted_token_ids, expert_ids, num_tokens_post_padded,
        exp_stride, ncols_x, nrows_x, ncols_y, nrows_y, nrows_dst, top_k);
  } else {
    constexpr bool need_check = true;
...
static void ggml_moe_q4_K_q8_1_cuda(
  ...
  if (nrows_x % mmq_y == 0) {
    constexpr bool need_check = false;
   hipLaunchKernelGGL(( moe_q4_K<scalar_t, need_check>), dim3(block_nums), dim3(block_dims), 0, stream, 
        w, inp, dst, sorted_token_ids, expert_ids, num_tokens_post_padded,
        exp_stride, ncols_x, nrows_x, ncols_y, nrows_y, nrows_dst, top_k);
  } else {
    constexpr bool need_check = true;
...
static void ggml_moe_q5_K_q8_1_cuda(
  ...
  if (nrows_x % mmq_y == 0) {
    constexpr bool need_check = false;
   hipLaunchKernelGGL(( moe_q5_K<scalar_t, need_check>), dim3(block_nums), dim3(block_dims), 0, stream, 
        w, inp, dst, sorted_token_ids, expert_ids, num_tokens_post_padded,
        exp_stride, ncols_x, nrows_x, ncols_y, nrows_y, nrows_dst, top_k);
  } else {
    constexpr bool need_check = true;
...
static void ggml_moe_q6_K_q8_1_cuda(
  ...
  if (nrows_x % mmq_y == 0) {
    constexpr bool need_check = false;
   hipLaunchKernelGGL(( moe_q6_K<scalar_t, need_check>), dim3(block_nums), dim3(block_dims), 0, stream, 
        w, inp, dst, sorted_token_ids, expert_ids, num_tokens_post_padded,
        exp_stride, ncols_x, nrows_x, ncols_y, nrows_y, nrows_dst, top_k);
  } else {
    constexpr bool need_check = true;
