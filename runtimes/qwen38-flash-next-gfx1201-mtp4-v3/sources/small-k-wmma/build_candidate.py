...
"""Build script for standalone prefill_q8_small_k_extension (WMMA K=320 candidate).
...
required = {"q8_small_k_wmma_kernel.cu", "q8_small_k_wmma_kernel.h", "build_candidate.py", "native_cpu_shim.cpp"}
...
source_file = root / "q8_small_k_wmma_kernel.cu"
header_file = root / "q8_small_k_wmma_kernel.h"
...
result = {
    ...
    "variants": {
        ...
        "candidate": {
            "name": "dedicated_dense_wmma_k320",
            "k_dimension": 320,
            "k_blocks": 10,
            "packed_row_bytes": 340,
            "tile_m": 32,
            "tile_n": 64,
            "threads_per_wg": 128,
            "waves_per_wg": 4,
            "launch_bounds": [128, 2],
            "lds_bytes_per_wg": 23552,
