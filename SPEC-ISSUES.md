...
## SI-18 — A1.14 — spec 8 §3 `residual_scale`
...
## SI-19 — A1.14 — spec 8 §3 `final_logit_softcap` / spec 1 §4
...
## SI-20 — A1.14 — spec 8 §3.1 MLA channel mapping / spec 1 §4 `split`+`concat`
...
## SI-21 — A1.14 — spec 1 §2.5 / §4.B rope positions binding
...
## SI-22 — A1.14 — spec 8 §2 builder value identity
...
## SI-23 — A1.14 — spec 8 §2, §5 MTP capture / spec 1 §3.2 subgraph inputs
